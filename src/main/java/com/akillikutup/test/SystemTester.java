...
public class SystemTester {
    ...
    public static void main(String[] args) {
        System.out.println(ANSI_BLUE + "=== Akilli Kutuphane [v4.2.0] Uctan Uca (E2E) Test Sistemi ===" + ANSI_RESET);
        ...
        try {
            ...
            User testUye = new User("Test Uye", "test@test.com", User.Role.UYE, "test1234");
